...
## LEDs
#set_property PACKAGE_PIN U16 [get_ports {st}]                                      
#        set_property IOSTANDARD LVCMOS33 [get_ports {st}]
#set_property PACKAGE_PIN E19 [get_ports {rs}]                                      
#        set_property IOSTANDARD LVCMOS33 [get_ports {rs}]
#set_property PACKAGE_PIN U19 [get_ports {ps}]                                      
#        set_property IOSTANDARD LVCMOS33 [get_ports {ps}]
#set_property PACKAGE_PIN V19 [get_ports {stp}]                                      
